...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/antoinedeng/Desktop/Simulator/src/Control)
  set(control_DEVEL_PREFIX /home/antoinedeng/Desktop/Simulator/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/antoinedeng/Desktop/Simulator/install)
...
if(NOT "/home/antoinedeng/Desktop/Simulator/devel/include " STREQUAL " ")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/antoinedeng/Desktop/Simulator/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'simonli <simonli@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/antoinedeng/Desktop/Simulator/src/Control/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/antoinedeng/Desktop/Simulator/devel/lib;/opt/ros/noetic/lib)
...
set(depends "geometry_msgs;roscpp;rospy;std_msgs;tf2;tf2_geometry_msgs;tf2_ros;turtlesim;message_runtime;image_transport;cv_bridge;sensor_msgs;opencv2")
